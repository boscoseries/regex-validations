...
describe("convert a number string to it currency equivalent", function() {
  ...
  test("It should return a currency representation of the number string", function() {
    expect(numberString.toCurrency()).toEqual(expect.stringContaining('10,123,496.134'));
  });
  test("It should return a currency representation of the number string", function() {
    expect(numberString2.toCurrency()).toEqual(expect.stringContaining('1,689,453'));
  });
  test("It should throw if type of input is not a string", function() {
    expect(function() { return nonString.toCurrency()}).toThrowError('not a function');
  });
  test("It should throw if input contains non-numbers", function() {
    expect(function() { return mixedString.toCurrency()}).toThrow();
  });
